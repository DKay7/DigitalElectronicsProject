...
mkdir -p build
rm -rf build/*
yosys -D LEDS_NR=0 -p "read_verilog counter8bit.v; read_verilog clock-div.v; read_verilog hex-to-seg.v; read_verilog draw-num-on-seg.v; hierarchy -top counter8bit; proc; opt; synth_gowin -json build/counter.json;"
